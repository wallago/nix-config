...
-- ===============================
-- focus
vim.keymap.set("n", "<leader>h", "<C-w>h", { noremap = true, silent = true, desc = "Switch window left" })
vim.keymap.set("n", "<leader>k", "<C-w>k", { noremap = true, silent = true, desc = "Switch window right" })
vim.keymap.set("n", "<leader>j", "<C-w>j", { noremap = true, silent = true, desc = "Switch window down" })
vim.keymap.set("n", "<leader>l", "<C-w>l", { noremap = true, silent = true, desc = "Switch window up" })
