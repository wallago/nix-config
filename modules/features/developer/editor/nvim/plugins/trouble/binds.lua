map("n", "<leader>xx", "<cmd>Trouble diagnostics toggle<cr>", { desc = "Trouble: diagnostics (workspace)" })
map(
	"n",
	"<leader>xX",
...
map("n", "<leader>xs", "<cmd>Trouble symbols toggle focus=false<cr>", { desc = "Trouble: symbols (outline)" })
map(
	"n",
	"<leader>xl",
